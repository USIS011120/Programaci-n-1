...
Class conversores
    ...
    Public valores()() As Double = {
       ...
       New Double() {1, 453.592, 0.453592, 16, 1.01, 0.000453592},
       New Double() {1, 80000000.0, 1000000.0, 1000, 0.001, 0.000001},
       New Double() {1, 3600, 60, 0.0416667, 0.000595238, 0.00136986, 0.000114155}
    }
    Public Function convertir(ByVal tipo As Int16, ByVal de As Int16, ByVal a As Int16, ByVal cantidad As Int16)
